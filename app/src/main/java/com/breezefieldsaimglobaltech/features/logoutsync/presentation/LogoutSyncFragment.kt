package com.breezefieldsaimglobaltech.features.logoutsync.presentation
...
import com.breezefieldsaimglobaltech.CustomConstants


import com.breezefieldsaimglobaltech.R
import com.breezefieldsaimglobaltech.app.AppDatabase
...
import com.breezefieldsaimglobaltech.app.utils.Toaster
...
import com.breezefieldsaimglobaltech.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsaimglobaltech.features.billing.api.AddBillingRepoProvider
import com.breezefieldsaimglobaltech.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsaimglobaltech.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsaimglobaltech.features.document.model.AddEditDocumentInputParams
import com.breezefieldsaimglobaltech.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsaimglobaltech.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsaimglobaltech.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsaimglobaltech.features.orderhistory.model.*
...
import com.breezefieldsaimglobaltech.features.quotation.model.AddQuotInputModel
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.breezefieldsaimglobaltech.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsaimglobaltech.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsaimglobaltech.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsaimglobaltech.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsaimglobaltech.mappackage.SendBrod
import com.breezefieldsaimglobaltech.widgets.AppCustomTextView
import com.breezefieldsaimglobaltech.MonitorService
import com.breezefieldsaimglobaltech.MySingleton
import com.breezefieldsaimglobaltech.app.AlarmReceiver
import com.breezefieldsaimglobaltech.features.addshop.model.*
import com.breezefieldsaimglobaltech.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefieldsaimglobaltech.features.addshop.presentation.ShopExtraContactReq
import com.breezefieldsaimglobaltech.features.addshop.presentation.multiContactRequestData
import com.breezefieldsaimglobaltech.features.contacts.CallHisDtls
import com.breezefieldsaimglobaltech.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsaimglobaltech.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldsaimglobaltech.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldsaimglobaltech.features.orderITC.SyncOpptProductL
import com.breezefieldsaimglobaltech.features.orderITC.SyncOrd
import com.breezefieldsaimglobaltech.features.orderITC.SyncOrdProductL
import com.breezefieldsaimglobaltech.features.performance.model.Gps_status_list
import com.breezefieldsaimglobaltech.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsaimglobaltech.features.returnsOrder.ReturnProductList
import com.breezefieldsaimglobaltech.features.returnsOrder.ReturnRequest
import com.breezefieldsaimglobaltech.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldsaimglobaltech.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldsaimglobaltech/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaimglobaltechlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaimglobaltechlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaimglobaltechlogsample/log.zip").path);
