package com.breezefieldsaimglobaltech.features.commondialogsinglebtn
...
import com.breezefieldsaimglobaltech.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldsaimglobaltech.app.domain.VisitRemarksEntity
...
import com.breezefieldsaimglobaltech.features.addshop.presentation.ProspectListDialog
import com.breezefieldsaimglobaltech.features.dashboard.presentation.DashboardActivity
import com.breezefieldsaimglobaltech.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldsaimglobaltech.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldsaimglobaltech/files", "recorded_audio${System.currentTimeMillis()}.mp3")
