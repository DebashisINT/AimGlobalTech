package com.breezefieldsaimglobaltech.features.dashboard.presentation
...
import com.breezefieldsaimglobaltech.*
import com.breezefieldsaimglobaltech.R
import com.breezefieldsaimglobaltech.app.*
import com.breezefieldsaimglobaltech.app.NewFileUtils.browseDocuments
import com.breezefieldsaimglobaltech.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsaimglobaltech.app.NewFileUtils.getExtension
import com.breezefieldsaimglobaltech.app.domain.*
import com.breezefieldsaimglobaltech.app.types.DashboardType
import com.breezefieldsaimglobaltech.app.types.FragType
import com.breezefieldsaimglobaltech.app.types.TopBarConfig
import com.breezefieldsaimglobaltech.app.uiaction.DisplayAlert
import com.breezefieldsaimglobaltech.app.utils.*
import com.breezefieldsaimglobaltech.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsaimglobaltech.base.BaseResponse
import com.breezefieldsaimglobaltech.base.presentation.BaseActivity
import com.breezefieldsaimglobaltech.base.presentation.BaseFragment
import com.breezefieldsaimglobaltech.features.NewQuotation.*
import com.breezefieldsaimglobaltech.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsaimglobaltech.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsaimglobaltech.features.SearchLocation.SearchLocationFragment
import com.breezefieldsaimglobaltech.features.SearchLocation.locationInfoModel
import com.breezefieldsaimglobaltech.features.TA.ViewAllTAListFragment
import com.breezefieldsaimglobaltech.features.achievement.AchievementFragment
import com.breezefieldsaimglobaltech.features.activities.presentation.*
import com.breezefieldsaimglobaltech.features.addAttendence.*
import com.breezefieldsaimglobaltech.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsaimglobaltech.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsaimglobaltech.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsaimglobaltech.features.addAttendence.model.GetReportToResponse
import com.breezefieldsaimglobaltech.features.addAttendence.model.Leave_list_Response
import com.breezefieldsaimglobaltech.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsaimglobaltech.features.addshop.presentation.AddShopFragment
import com.breezefieldsaimglobaltech.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsaimglobaltech.features.addshop.presentation.ScanImageFragment
import com.breezefieldsaimglobaltech.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsaimglobaltech.features.alarm.model.AlarmData
import com.breezefieldsaimglobaltech.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsaimglobaltech.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsaimglobaltech.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsaimglobaltech.features.alarm.presetation.VisitReportFragment
import com.breezefieldsaimglobaltech.features.attendance.AttendanceFragment
import com.breezefieldsaimglobaltech.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsaimglobaltech.features.attendance.model.AttendanceRequest
import com.breezefieldsaimglobaltech.features.attendance.model.AttendanceResponse
import com.breezefieldsaimglobaltech.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsaimglobaltech.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsaimglobaltech.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsaimglobaltech.features.beatCustom.TeamBeatListFragment
import com.breezefieldsaimglobaltech.features.billing.presentation.AddBillingFragment
import com.breezefieldsaimglobaltech.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsaimglobaltech.features.billing.presentation.BillingListFragment
import com.breezefieldsaimglobaltech.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsaimglobaltech.features.chat.model.ChatListDataModel
import com.breezefieldsaimglobaltech.features.chat.model.ChatUserDataModel
import com.breezefieldsaimglobaltech.features.chat.model.GroupUserDataModel
import com.breezefieldsaimglobaltech.features.chat.presentation.*
import com.breezefieldsaimglobaltech.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsaimglobaltech.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsaimglobaltech.features.chatbot.presentation.ReportsFragment
import com.breezefieldsaimglobaltech.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsaimglobaltech.features.commondialog.presentation.CommonDialog
import com.breezefieldsaimglobaltech.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsaimglobaltech.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsaimglobaltech.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsaimglobaltech.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsaimglobaltech.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsaimglobaltech.features.contacts.ActivityDtlsFrag
import com.breezefieldsaimglobaltech.features.contacts.AddOpptFrag
import com.breezefieldsaimglobaltech.features.contacts.ContactDtls
import com.breezefieldsaimglobaltech.features.contacts.ContactGr
import com.breezefieldsaimglobaltech.features.contacts.ContactsAddFrag
import com.breezefieldsaimglobaltech.features.contacts.ContactsFrag
import com.breezefieldsaimglobaltech.features.contacts.SchedulerAddFormFrag
import com.breezefieldsaimglobaltech.features.contacts.SchedulerViewFrag
import com.breezefieldsaimglobaltech.features.contacts.TemplateAddFrag
import com.breezefieldsaimglobaltech.features.contacts.TemplateViewFrag
import com.breezefieldsaimglobaltech.features.contacts.ViewCrmOpptFrag
import com.breezefieldsaimglobaltech.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsaimglobaltech.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsaimglobaltech.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsaimglobaltech.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsaimglobaltech.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsaimglobaltech.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsaimglobaltech.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsaimglobaltech.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsaimglobaltech.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsaimglobaltech.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsaimglobaltech.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsaimglobaltech.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsaimglobaltech.features.document.presentation.DocumentListFragment
import com.breezefieldsaimglobaltech.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsaimglobaltech.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsaimglobaltech.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsaimglobaltech.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsaimglobaltech.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsaimglobaltech.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsaimglobaltech.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsaimglobaltech.features.home.presentation.HomeFragment
import com.breezefieldsaimglobaltech.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsaimglobaltech.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsaimglobaltech.features.know_your_state.KnowYourStateFragment
import com.breezefieldsaimglobaltech.features.lead.LeadFrag
import com.breezefieldsaimglobaltech.features.lead.ViewLeadFrag
import com.breezefieldsaimglobaltech.features.leaderboard.LeaderBoardFrag
import com.breezefieldsaimglobaltech.features.leaveapplynew.LeaveHome
import com.breezefieldsaimglobaltech.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsaimglobaltech.features.localshops.LocalShopListFragment
import com.breezefieldsaimglobaltech.features.localshops.LocalShopListMapFragment
import com.breezefieldsaimglobaltech.features.localshops.NearByShopsMapFragment
import com.breezefieldsaimglobaltech.features.location.*
import com.breezefieldsaimglobaltech.features.location.api.LocationRepoProvider
import com.breezefieldsaimglobaltech.features.location.model.*
import com.breezefieldsaimglobaltech.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsaimglobaltech.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsaimglobaltech.features.login.ShopFeedbackEntity
import com.breezefieldsaimglobaltech.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsaimglobaltech.features.login.presentation.LoginActivity
import com.breezefieldsaimglobaltech.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsaimglobaltech.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsaimglobaltech.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsaimglobaltech.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsaimglobaltech.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsaimglobaltech.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsaimglobaltech.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsaimglobaltech.features.member.MapViewForTeamFrag
import com.breezefieldsaimglobaltech.features.member.model.TeamLocDataModel
import com.breezefieldsaimglobaltech.features.member.model.TeamShopListDataModel
import com.breezefieldsaimglobaltech.features.member.presentation.*
import com.breezefieldsaimglobaltech.features.menuBeat.MenuBeatFrag
import com.breezefieldsaimglobaltech.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsaimglobaltech.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsaimglobaltech.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsaimglobaltech.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsaimglobaltech.features.myjobs.model.CustomerDataModel
import com.breezefieldsaimglobaltech.features.myjobs.presentation.*
import com.breezefieldsaimglobaltech.features.mylearning.MyLearningFragment
import com.breezefieldsaimglobaltech.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsaimglobaltech.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsaimglobaltech.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsaimglobaltech.features.nearbyshops.model.ShopData
import com.breezefieldsaimglobaltech.features.nearbyshops.model.ShopListResponse
import com.breezefieldsaimglobaltech.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsaimglobaltech.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsaimglobaltech.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsaimglobaltech.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsaimglobaltech.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsaimglobaltech.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsaimglobaltech.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsaimglobaltech.features.newcollection.CollectionShopListFragment
import com.breezefieldsaimglobaltech.features.newcollection.NewCollectionListFragment
import com.breezefieldsaimglobaltech.features.newcollectionreport.*
import com.breezefieldsaimglobaltech.features.notification.NotificationFragment
import com.breezefieldsaimglobaltech.features.orderITC.CartListFrag
import com.breezefieldsaimglobaltech.features.orderITC.OrderListFrag
import com.breezefieldsaimglobaltech.features.orderITC.ProductListFrag
import com.breezefieldsaimglobaltech.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsaimglobaltech.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsaimglobaltech.features.orderITC.ViewOrdDtls
import com.breezefieldsaimglobaltech.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsaimglobaltech.features.orderList.NewOrderListFragment
import com.breezefieldsaimglobaltech.features.orderList.OrderListFragment
import com.breezefieldsaimglobaltech.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsaimglobaltech.features.orderhistory.ActivityMapFragment
import com.breezefieldsaimglobaltech.features.orderhistory.OrderhistoryFragment
import com.breezefieldsaimglobaltech.features.orderhistory.TimeLineFragment
import com.breezefieldsaimglobaltech.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsaimglobaltech.features.orderhistory.model.LocationData
import com.breezefieldsaimglobaltech.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsaimglobaltech.features.performance.GpsStatusFragment
import com.breezefieldsaimglobaltech.features.performance.PerformanceFragment
import com.breezefieldsaimglobaltech.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsaimglobaltech.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsaimglobaltech.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsaimglobaltech.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsaimglobaltech.features.performanceAPP.allPerformanceFrag
import com.breezefieldsaimglobaltech.features.permissionList.ViewPermissionFragment
import com.breezefieldsaimglobaltech.features.photoReg.*
import com.breezefieldsaimglobaltech.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsaimglobaltech.features.quotation.presentation.*
import com.breezefieldsaimglobaltech.features.reimbursement.presentation.*
import com.breezefieldsaimglobaltech.features.report.presentation.*
import com.breezefieldsaimglobaltech.features.returnsOrder.*
import com.breezefieldsaimglobaltech.features.settings.presentation.SettingsFragment
import com.breezefieldsaimglobaltech.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.*
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsaimglobaltech.features.stock.StockDetailsFragment
import com.breezefieldsaimglobaltech.features.stock.StockListFragment
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsaimglobaltech.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsaimglobaltech.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsaimglobaltech.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsaimglobaltech.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsaimglobaltech.features.survey.SurveyFrag
import com.breezefieldsaimglobaltech.features.survey.SurveyViewDtlsFrag
import com.breezefieldsaimglobaltech.features.survey.SurveyViewFrag
import com.breezefieldsaimglobaltech.features.task.presentation.AddTaskFragment
import com.breezefieldsaimglobaltech.features.task.presentation.CalenderTaskFragment
import com.breezefieldsaimglobaltech.features.task.presentation.EditTaskFragment
import com.breezefieldsaimglobaltech.features.task.presentation.TaskListFragment
import com.breezefieldsaimglobaltech.features.taskManagement.TaskManagementFrag
import com.breezefieldsaimglobaltech.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsaimglobaltech.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsaimglobaltech.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsaimglobaltech.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.CartFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.ViewCartFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsaimglobaltech.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsaimglobaltech.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsaimglobaltech.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsaimglobaltech.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsaimglobaltech.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsaimglobaltech.features.weather.presentation.WeatherFragment
import com.breezefieldsaimglobaltech.mappackage.MapActivity
import com.breezefieldsaimglobaltech.mappackage.MapActivityWithoutPath
import com.breezefieldsaimglobaltech.mappackage.SendBrod
import com.breezefieldsaimglobaltech.widgets.AppCustomEditText
import com.breezefieldsaimglobaltech.widgets.AppCustomTextView
...
import com.breezefieldsaimglobaltech.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldsaimglobaltech.features.login.model.NewSettingsResponseModel
import com.breezefieldsaimglobaltech.features.mylearning.AllTopicsWiseContents
import com.breezefieldsaimglobaltech.features.mylearning.BookmarkFetchResponse
import com.breezefieldsaimglobaltech.features.mylearning.BookmarkFrag
import com.breezefieldsaimglobaltech.features.mylearning.BookmarkPlayFrag
import com.breezefieldsaimglobaltech.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsaimglobaltech.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsaimglobaltech.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsaimglobaltech.features.mylearning.MyLearningAllVideoList
import com.breezefieldsaimglobaltech.features.mylearning.MyLearningTopicList
import com.breezefieldsaimglobaltech.features.mylearning.MyLearningVideoPlay
import com.breezefieldsaimglobaltech.features.mylearning.MyPerformanceFrag
import com.breezefieldsaimglobaltech.features.mylearning.MyTopicsWiseContents
import com.breezefieldsaimglobaltech.features.mylearning.NotificationLMSFragment
import com.breezefieldsaimglobaltech.features.mylearning.RetryIncorrectQuizFrag
import com.breezefieldsaimglobaltech.features.mylearning.RetryPlayFrag
import com.breezefieldsaimglobaltech.features.mylearning.RetryQuestionFrag
import com.breezefieldsaimglobaltech.features.mylearning.SearchLmsFrag
import com.breezefieldsaimglobaltech.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsaimglobaltech.features.mylearning.SearchLmsLearningFrag
import com.breezefieldsaimglobaltech.features.mylearning.VideoPlayLMS
import com.breezefieldsaimglobaltech.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsaimglobaltechlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaimglobaltechlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsaimglobaltech/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsaimglobaltechlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsaimglobaltechlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsaimglobaltechlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
