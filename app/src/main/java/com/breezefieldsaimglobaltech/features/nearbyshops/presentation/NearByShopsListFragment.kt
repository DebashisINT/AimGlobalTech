...
import com.breezefieldsaimglobaltech.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldsaimglobaltech.app.utils.FTStorageUtils
import com.breezefieldsaimglobaltech.app.utils.NotificationUtils
...
import com.breezefieldsaimglobaltech.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldsaimglobaltech.features.addshop.model.QuestionSubmit
import com.breezefieldsaimglobaltech.features.addshop.model.UpdateAddrReq
import com.breezefieldsaimglobaltech.features.addshop.model.UpdateAddressShop
...
import com.breezefieldsaimglobaltech.features.addshop.presentation.*
...
import com.breezefieldsaimglobaltech.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldsaimglobaltech.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldsaimglobaltech.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldsaimglobaltech.features.shopdetail.presentation.AddCollectionDialog
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldsaimglobaltechApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
